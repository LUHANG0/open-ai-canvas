...
export function DeliveryStage({ detail, unitId }: { detail: ProjectDetail; unitId: string }) {
    ...
    const exportDelivery = async () => {
        ...
        setExporting(true);
        setProgress({ phase: "reading", progress: 0, message: "正在准备镜头视频" });
        try {
