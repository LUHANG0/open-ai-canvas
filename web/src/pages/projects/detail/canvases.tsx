...
export default function ProjectCanvasesView({ detail, refreshProject, onCreateCanvas }: ProjectDetailViewProps) {
    ...
    return (
        <div className="pc-project-canvases">
            ...
            {canvasesQuery.isLoading ? (
                ...
                <WorkspaceState
                    icon="canvas"
                    className="pc-project-detail-state"
                    title="还没有项目画布"
                    description="使用右上角的新建画布开始创作。"
                    action={
                        <Button className="pc-project-detail-empty-action" type="primary" onClick={onCreateCanvas}>
                            新建项目画布
                        </Button>
                    }
                />
