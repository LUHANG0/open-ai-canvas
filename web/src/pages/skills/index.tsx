                ...
                >
                    <ViewToggle
                        ...
                        options={scopeOptions.map((option) => {
                            ...
                            return {
                                value: option.value as SkillScope,
                                icon: <Icon className="size-4" />,
                                label: (
                                    <span className="skills-scope-label">
                                        {option.label}
                                ...
                                return (
                                    <section key={group.value} aria-labelledby={`skill-category-${group.value}`}>
                                        <SectionHeader
                                            ...
                                            titleId={`skill-category-${group.value}`}
                                            title={group.label}
                                            eyebrow="技能分类"
                                            meta={<span>{group.skills.length} 个</span>}
                                            actions={
