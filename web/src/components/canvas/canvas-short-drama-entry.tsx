...
import { AlignLeft, ArrowRight, Bot, ChevronDown, Clapperboard, FolderKanban, Images, MoreHorizontal, Palette, Pencil, Plus, Sparkles, Type, Upload } from "lucide-react";
