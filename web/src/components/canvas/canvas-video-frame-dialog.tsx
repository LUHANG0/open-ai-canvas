...
export function CanvasVideoFrameDialog({ node, open, onClose, onConfirm }: CanvasVideoFrameDialogProps) {
    ...
    return (
        <Modal rootClassName="pc-canvas-overlay pc-canvas-modal pc-canvas-media-modal" title={title} open={open} onCancel={onClose} footer={null} width={760} centered destroyOnHidden>
