...
func newChannelModelTestService(t *testing.T) (*Service, *gorm.DB) {
	...
	if err := db.AutoMigrate(&model.ModelChannel{}, &model.ChannelModel{}, &model.ChannelModelPriceTier{}, &model.ChannelModelRevision{}, &model.AdminAuditEvent{}, &model.IDSequence{}); err != nil {
		t.Fatal(err)
	}
